...
import com.thalasoft.butik.data.exception.CannotDeleteEntityException;
...
import com.thalasoft.butik.data.exception.NoEntitiesFoundException;
...
public class ExceptionsHandler extends AbstractExceptionHandler {
  ...
  @ResponseBody
  public ResponseEntity<ErrorInfo> cannotEncodePasswordException(HttpServletRequest request,
      CannotEncodePasswordException e) {
