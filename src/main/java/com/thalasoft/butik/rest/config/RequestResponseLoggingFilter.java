...
public class RequestResponseLoggingFilter extends OncePerRequestFilter {
  ...
  protected void doFilterWrapped(ContentCachingRequestWrapper request, ContentCachingResponseWrapper response,
    ...
    try {
      ...
      // The response body needs to be copied back to the response as the wrapper
      // clears the response body when it caches it
  ...
  private static void logRequestHeader(ContentCachingRequestWrapper request, String prefix) {
    ...
    Collections.list(request.getHeaderNames()).forEach(headerName -> Collections.list(request.getHeaders(headerName))
